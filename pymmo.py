...
# defines static/non static functions
def SAVE():
    global steps
    global money
    global level
...
def PrintLogo():
    print(
        "[bold red]          _____                _____                    _____                    _____                   _______ [/]"
        "\n[bold blue]         /\    \              |\    \                  /\    \                  /\    \                 /::\    \ [/]"
        "\n[bold red]        /::\    \             |:\____\                /::\____\                /::\____\               /::::\    \ [/]"
        "\n[bold blue]       /::::\    \            |::|   |               /::::|   |               /::::|   |              /::::::\    \ [/]"
        "\n[bold red]      /::::::\    \           |::|   |              /:::::|   |              /:::::|   |             /::::::::\    \ [/]"
        "\n[bold blue]     /:::/\:::\    \          |::|   |             /::::::|   |             /::::::|   |            /:::/~~\:::\    \ [/]"
        "\n[bold red]    /:::/__\:::\    \         |::|   |            /:::/|::|   |            /:::/|::|   |           /:::/    \:::\    \ [/]"
        "\n[bold blue]   /::::\   \:::\    \        |::|   |           /:::/ |::|   |           /:::/ |::|   |          /:::/    / \:::\    \ [/]"
        "\n[bold red]  /::::::\   \:::\    \       |::|___|______    /:::/  |::|___|______    /:::/  |::|___|______   /:::/____/   \:::\____\ [/]"
        "\n[bold blue] /:::/\:::\   \:::\____\      /::::::::\    \  /:::/   |::::::::\    \  /:::/   |::::::::\    \ |:::|    |     |:::|    | [/]"
        "\n[bold red]/:::/  \:::\   \:::|    |    /::::::::::\____\/:::/    |:::::::::\____\/:::/    |:::::::::\____\|:::|____|     |:::|    | [/]"
        "\n[bold blue]\::/    \:::\  /:::|____|   /:::/~~~~/~~      \::/    / ~~~~~/:::/    /\::/    / ~~~~~/:::/    / \:::\    \   /:::/    /[/]"
        "\n[bold red] \/_____/\:::\/:::/    /   /:::/    /          \/____/      /:::/    /  \/____/      /:::/    /   \:::\    \ /:::/    / [/]"
        "\n[bold blue]          \::::::/    /   /:::/    /                       /:::/    /               /:::/    /     \:::\    /:::/    / [/]"
        "\n[bold red]           \::::/    /   /:::/    /                       /:::/    /               /:::/    /       \:::\__/:::/    / [/]"
        "\n[bold blue]            \::/____/    \::/    /                       /:::/    /               /:::/    /         \::::::::/    / [/]"
        "\n[bold red]             ~~           \/____/                       /:::/    /               /:::/    /           \::::::/    / [/]"
...
if not os.path.exists('.GAMEDATA'):
    ...
    while True:
        ...
        temp1 = input("Do you want this password?(y, n)...").strip().lower()
        if temp1 == "y":
            break
        else:
            continue
...
if not firstLogin:
    ...
    while True:
                ...
                if temp2 == "":
                    ...
                    while True:
                        ...
                        if input(f"{jobDone}(y, n)...") == "y":
                            temp1 = input("\nHow long will the job be?(1min, 3min, 5min)...").strip().lower()
                            if temp1 == "1min":
                                temp0 = 60  # money
                                temp2 = 1  # level
                                jobDone = True
                    ...
                    while True:
                        ...
                        if choice == "1":  # casino choose game
                            ...
                            if money > 5:
                                ...
                                moneyFromGame = input("Enter amount of money to bet...").strip()
                                while True:
            ...
            while True:
                ...
                try:
                    for weapons in ownedItems:
                        ...
                        namesOfOwnedWeapons.append(weapon.name[num].lower())
                        num += 1
                ...
                itemSelected = ""
                temp2 = input("Select an item(Or exit /)...").strip().lower()
                if temp2 in namesOfOwnedWeapons:
                    ...
                    while True:
                        ...
                        if temp2 == "":
                            ...
                            if input(f"Are you sure you want to sell {weapon.name[itemSelected]}(y, n)?..").strip().lower() == "y":
                                print(
                            ...
                            if input(f"Are you sure you want to discard {weapon.name[itemSelected]}(y, n)?..").strip().lower() == "y":
            ...
            while True:
                ...
                if temp2 == "":
                    ...
                    while True:
                        ...
                        while len(username) > 20:
                            username = input("Please enter a shorter username...").strip()
        ...
        # exits game and saves stuff
            ...
            while True:
                temp0 = 0
                temp0 = input("Are you sure(y, n)?..").lower().strip()
                if temp0 == "y":
